...
namespace DAL
{
    ...
    {
        private static string connstr = "server=127.0.0.1;database=demo;username=root;password=111111;";
        ...
        /// <param name="cmdText">SQL语句</param>
        /// <returns></returns>
        private DataTable ExecuteDataTable(MySqlConnection conn, string cmdText)
        {
        ...
        #region 执行带参数的插入、更新、删除操作，返回受影响的行数

        /// <summary>
        /// 执行带参数的插入、更新、删除操作，返回受影响的行数
        /// </summary>
        /// <param name="sqlString"></param>
        /// <param name="cmdParms"></param>
        /// <returns></returns>
        ...
        #region 执行带参数的查询语句，返回第一行第一列的值

        /// <summary>
        /// 执行带参数的查询语句，返回第一行第一列的值
        /// </summary>
        /// <param name="sqlString"></param>
        /// <param name="cmdParms"></param>
        /// <returns></returns>
